...
my local laptop, I found that \code{JAX} began to outperform \code{NumPy}
after about 1000 replications of fitting the ridge regression
models. 

These results are based around fairly
subpar \code{NumPy} code for fitting ridge regression models, as the \code{NumPy} 
...
this package provides a gentle wrapper around \code{JAX} that allows faster
